...
project = 'NDD Docker Sphinx Test'
copyright = '2018, David DIDIER'
author = 'David DIDIER'
...
htmlhelp_basename = 'NDDDockerSphinxTestdoc'
...
latex_documents = [
    (master_doc, 'NDDDockerSphinxTest.tex', 'NDD Docker Sphinx Test Documentation',
     'David DIDIER', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndddockersphinxtest', 'NDD Docker Sphinx Test Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NDDDockerSphinxTest', 'NDD Docker Sphinx Test Documentation',
     author, 'NDDDockerSphinxTest', 'One line description of project.',
     'Miscellaneous'),
]
